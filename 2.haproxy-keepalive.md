...
backend workers-http
    ...
    server masterone 192.168.29.51:32059 check
    server mastertwo 192.168.29.52:32059 check
    server masterthree 192.168.29.53:32059 check


# ===============================
# NODEPORT HTTPS (Port 443 → 32443)
# ===============================
...
backend workers-https
    ...
    server masterone 192.168.29.51:32443 check
    server mastertwo 192.168.29.52:32443 check
    server masterthree 192.168.29.53:32443 check
...
backend nodeport-backend
  ...
  server masterone 192.168.29.51
  server mastertwo 192.168.29.52
  server masterthree 192.168.29.53
EOF
```
